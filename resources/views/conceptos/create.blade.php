...
@section('content')
    @include('users.partials.header', ['title' => __('Agregar Concepto')])   
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('conceptos.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('descripcion') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="descripcion" id="input-descripcion" class="form-control form-control-alternative{{ $errors->has('descripcion') ? ' is-invalid' : '' }}" placeholder="{{ __('Descripcion') }}" value="{{ old('descripcion') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('unidad') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="unidad" id="input-unidad" class="form-control form-control-alternative{{ $errors->has('unidad') ? ' is-invalid' : '' }}" placeholder="{{ __('Unidad (Kg,Pza)') }}" value="{{ old('unidad') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('cantidad') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="cantidad" id="input-cantidad" class="form-control form-control-alternative{{ $errors->has('cantidad') ? ' is-invalid' : '' }}" placeholder="{{ __('Cantidad') }}" value="{{ old('cantidad', 0) }}" max="200000" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('pu') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="pu" id="input-pu" class="form-control form-control-alternative{{ $errors->has('pu') ? ' is-invalid' : '' }}" placeholder="{{ __('Precio Unitario') }}" value="{{ old('pu', 0.0) }}" max="200000" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('area') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="area" id="input-area" class="form-control form-control-alternative{{ $errors->has('area') ? ' is-invalid' : '' }}" placeholder="{{ __('Area') }}" value="{{ old('area') }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('estado_conceptos') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="estado_conceptos" id="input-estado_conceptos" class="form-control form-control-alternative{{ $errors->has('estado_conceptos') ? ' is-invalid' : '' }}" placeholder="{{ __('estado_conceptos') }}" value="{{ old('estado_conceptos') }}" autofocus>
