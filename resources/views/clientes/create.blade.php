                        ...
                        <form method="post" action="{{route('clientes.store')}}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('nombre_cliente') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nombre_cliente" id="input-nombre" class="form-control form-control-alternative{{ $errors->has('nombre_cliente') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre') }}" value="{{ old('nombre_cliente') }}" required autofocus>
